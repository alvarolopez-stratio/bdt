...
@CucumberOptions(plugin = "json:target/cucumber.json", features = {"src/test/resources/features/convertYamlToJsonFile.feature"})
public class YamlConvertToJsonIT extends BaseGTest {
